...
require_once '../includes/attendance_stats.php'; // Include attendance stats functions
...
$stats = getAllAttendanceStats($conn);
$monthName = date('F Y'); // Current month and year
...
<head>
    ...
    <style>
        * {
        ...
        background-color:rgb(71, 204, 51);
        border: none;
        }

        .statusBtn.btn-warning {
        background-color:rgb(197, 78, 72);
        border: none;
        }
    ...
    <div class="main-content">
        ...
        <div class="metrics-grid">
            <div class="metric-card">
                <div class="metric-label">Total Records (<?php echo $monthName; ?>)</div>
                <div class="metric-value"><?php echo $stats['monthly_records']; ?></div>
                <div class="metric-subtitle">Monthly attendance records</div>
            </div>
            <div class="metric-card">
                <div class="metric-label">Present Today</div>
                <div class="metric-value"><?php echo $stats['present']['count']; ?></div>
                <div class="metric-subtitle positive-change"><?php echo $stats['present']['percentage']; ?>% attendance rate</div>
            </div>
            <div class="metric-card">
                <div class="metric-label">Late Arrivals Today</div>
                <div class="metric-value"><?php echo $stats['late']['count']; ?></div>
                <div class="metric-subtitle negative-change"><?php echo $stats['late']['percentage']; ?>% of present employees</div>
            </div>
            <div class="metric-card">
                <div class="metric-label">Absent Today</div>
                <div class="metric-value"><?php echo $stats['absent']['count']; ?></div>
                <div class="metric-subtitle negative-change"><?php echo $stats['absent']['percentage']; ?>% absence rate</div>
            </div>
        </div>
